...
/// <summary>
/// Comando para actualizar campos de un documento de Compra existente en CONTPAQi Comercial.
...
/// </summary>
public class UpdateCompraCommand : IRequest<int>
{
    /// <summary>
    /// Código del concepto de la compra. Se asigna automáticamente desde la URL.
    /// No es necesario incluirlo en el cuerpo del request.
    /// </summary>
    public string CodigoConcepto { get; set; } = string.Empty;

    /// <summary>
    /// Serie de la compra. Se asigna automáticamente desde la URL.
    /// </summary>
    public string Serie { get; set; } = string.Empty;

    /// <summary>
    /// Folio de la compra. Se asigna automáticamente desde la URL.
    /// </summary>
    public string Folio { get; set; } = string.Empty;

    /// <summary>
    /// Nuevo código del proveedor al que se le compra. Opcional. Máximo 30 caracteres.
    /// Ejemplo: "PROV005"
    /// </summary>
    [StringLength(30, ErrorMessage = "El código del proveedor no puede exceder 30 caracteres.")]
    public string? CodigoProveedor { get; set; }

    /// <summary>
    /// Nueva referencia (ej. número de factura del proveedor). Opcional. Máximo 30 caracteres.
    /// Ejemplo: "FAC-PROV-20240315"
    /// </summary>
    [StringLength(30, ErrorMessage = "La referencia no puede exceder 30 caracteres.")]
    public string? Referencia { get; set; }

    /// <summary>
    /// Nueva fecha de la compra. Opcional.
    /// Formato esperado: "MM/dd/yyyy". Ejemplo: "03/15/2024"
    /// </summary>
    public DateTime? Fecha { get; set; }

    /// <summary>
    /// Observaciones generales de la compra. Opcional. Máximo 500 caracteres.
    /// </summary>
    [StringLength(500, ErrorMessage = "Las observaciones no pueden exceder 500 caracteres.")]
    public string? Observaciones { get; set; }

    /// <summary>
    /// Nuevo tipo de cambio. Opcional. Debe ser mayor a 0.
    /// </summary>
    [Range(0.0001, double.MaxValue, ErrorMessage = "El tipo de cambio debe ser mayor a 0.")]
    public double? TipoCambio { get; set; }

    /// <summary>
    /// Texto extra 1 del documento de compra. Opcional. Máximo 50 caracteres.
    /// </summary>
    [StringLength(50, ErrorMessage = "TextoExtra1 no puede exceder 50 caracteres.")]
    public string? TextoExtra1 { get; set; }

    /// <summary>
    /// Texto extra 2 del documento de compra. Opcional. Máximo 50 caracteres.
    /// </summary>
    [StringLength(50, ErrorMessage = "TextoExtra2 no puede exceder 50 caracteres.")]
    public string? TextoExtra2 { get; set; }

    /// <summary>
    /// Texto extra 3 del documento de compra. Opcional. Máximo 50 caracteres.
    /// </summary>
    [StringLength(50, ErrorMessage = "TextoExtra3 no puede exceder 50 caracteres.")]
    public string? TextoExtra3 { get; set; }
}

public class UpdateCompraCommandHandler : IRequestHandler<UpdateCompraCommand, int>
{
    private readonly IContpaqiSdk _sdk;

    public UpdateCompraCommandHandler(IContpaqiSdk sdk)
    {
        _sdk = sdk;
    }

    public async Task<int> Handle(UpdateCompraCommand request, CancellationToken cancellationToken)
    {
        var datos = new Dictionary<string, string>();

        if (!string.IsNullOrWhiteSpace(request.CodigoProveedor))
            datos["CCODIGOCTEPROV"] = request.CodigoProveedor;
        ...
        if (datos.Count == 0)
            throw new ArgumentException(
                ...
                "CodigoProveedor, Fecha, Referencia, Observaciones, " +
                "TipoCambio, TextoExtra1, TextoExtra2 o TextoExtra3.");
