...
/// <summary>
/// Comando para actualizar campos de un documento de Entrada de Almacén existente en CONTPAQi Comercial.
...
/// </summary>
public class UpdateEntradaAlmacenCommand : IRequest<int>
{
    /// <summary>
    /// Código del concepto de la entrada. Se asigna automáticamente desde la URL.
    /// </summary>
    ...
    /// <summary>
    /// Nueva referencia o motivo de la entrada. Opcional. Máximo 30 caracteres.
    /// Ejemplo: "Compra directa proveedor", "Ajuste inventario"
    /// </summary>
    [StringLength(30, ErrorMessage = "La referencia no puede exceder 30 caracteres.")]
    public string? Referencia { get; set; }

    /// <summary>
    /// Nueva fecha de la entrada de almacén. Opcional.
    /// Formato esperado: "MM/dd/yyyy". Ejemplo: "03/15/2024"
    /// </summary>
    public DateTime? Fecha { get; set; }

    /// <summary>
    /// Observaciones sobre la entrada. Opcional. Máximo 500 caracteres.
    /// </summary>
...
public class UpdateEntradaAlmacenCommandHandler : IRequestHandler<UpdateEntradaAlmacenCommand, int>
{
    private readonly IContpaqiSdk _sdk;

    public UpdateEntradaAlmacenCommandHandler(IContpaqiSdk sdk)
    {
        _sdk = sdk;
    }

    public async Task<int> Handle(UpdateEntradaAlmacenCommand request, CancellationToken cancellationToken)
    {
