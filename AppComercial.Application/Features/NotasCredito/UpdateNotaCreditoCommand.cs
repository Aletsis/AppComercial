...
/// <summary>
/// Comando para actualizar campos de una Nota de Crédito / Devolución existente en CONTPAQi Comercial.
...
/// </summary>
public class UpdateNotaCreditoCommand : IRequest<int>
{
    ...
    /// <summary>Serie de la nota de crédito. Se asigna automáticamente desde la URL.</summary>
    public string Serie { get; set; } = string.Empty;

    /// <summary>Folio de la nota de crédito. Se asigna automáticamente desde la URL.</summary>
    public string Folio { get; set; } = string.Empty;

    /// <summary>
    /// Nuevo código del cliente que realizó la devolución. Opcional. Máximo 30 caracteres.
    /// Ejemplo: "CLI001"
    /// </summary>
    ...
    /// <summary>
    /// Nueva fecha de la nota de crédito. Opcional.
    /// Formato esperado: "MM/dd/yyyy". Ejemplo: "03/15/2024"
    /// </summary>
    public DateTime? Fecha { get; set; }

    /// <summary>
    /// Nueva referencia al documento de venta original. Opcional. Máximo 30 caracteres.
    /// Ejemplo: "FAC-A-100"
    /// </summary>
    [StringLength(30, ErrorMessage = "La referencia no puede exceder 30 caracteres.")]
    public string? ReferenciaDocumentoOrigen { get; set; }

    /// <summary>Observaciones sobre la devolución. Opcional. Máximo 500 caracteres.</summary>
...
public class UpdateNotaCreditoCommandHandler : IRequestHandler<UpdateNotaCreditoCommand, int>
{
    private readonly IContpaqiSdk _sdk;

    public UpdateNotaCreditoCommandHandler(IContpaqiSdk sdk)
    {
        _sdk = sdk;
    }

    public async Task<int> Handle(UpdateNotaCreditoCommand request, CancellationToken cancellationToken)
    {
        ...
        if (!string.IsNullOrWhiteSpace(request.ReferenciaDocumentoOrigen))
            datos["CREFERENCIA"] = request.ReferenciaDocumentoOrigen;
        ...
        if (datos.Count == 0)
            throw new ArgumentException(
                ...
                "CodigoCliente, Fecha, ReferenciaDocumentoOrigen, Observaciones, " +
                "TextoExtra1, TextoExtra2 o TextoExtra3.");
